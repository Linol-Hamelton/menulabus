    ...
    <div class="account-container">
        ...
        <section class="account-section" id="billing-helper">
            ...
            <div class="admin-form-container">
                ...
                <ul>
                    <li>Откройте <a href="/owner.php?tab=billing">/owner.php?tab=billing</a> — там видно: текущий тариф, статус (trial/active/past_due/suspended/cancelled), дата следующего списания, сохранённая карта, история инвойсов.</li>
                    <li>Пробный период — 14 дней тарифа «Меню» с момента регистрации, карта не требуется.</li>
                    <li>Чтобы продолжить после пробника — кнопка «Добавить карту» открывает безопасную форму YooKassa. После сохранения карта используется для автоматических списаний.</li>
                    <li>«Сменить тариф» — переключение между уровнями. Upgrade применяется сразу (новая цена со следующего цикла); downgrade — на конец оплаченного периода.</li>
                    <li>Тариф действует на одну торговую точку. У сети из нескольких точек — своя подписка на каждую.</li>
                </ul>
            </div>

            <div class="admin-form-container">
                <h3>Уровни тарифов — что входит</h3>
                <ul>
                    <li><strong>Меню</strong> — публичное меню с категориями, составом и БЖУ + QR-коды столов. Без корзины и кабинета клиента.</li>
                    <li><strong>Заказ+</strong> — всё из «Меню» + корзина, кабинет клиента, заказы в зале, бронь столов, чаевые, онлайн-оплата, отзывы, лояльность.</li>
                    <li><strong>Доставка+</strong> — всё из «Заказ+» + самовывоз, доставка, свои курьеры, агрегаторы (Яндекс.Еда, Delivery Club), лист ожидания.</li>
                    <li><strong>Контроль+</strong> — всё из «Доставка+» + аналитика выручки и когорт, фискальные чеки 54-ФЗ, модерация отзывов, маркетинговые кампании, webhooks.</li>
                    <li><strong>Смена+</strong> — всё из «Контроль+» + управление штатом, график смен, тип-пул, обмен сменами, кассовая смена с Z-отчётом, кухонный экран (KDS).</li>
                    <li><strong>Кухня+</strong> — всё из «Смена+» + склад, ингредиенты, техкарты, авто-списание себестоимости, инвентаризация, полуфабрикаты, ЕГАИС, ВСД «Меркурий», поставщики.</li>
                    <li><strong>Сеть+</strong> — для сетей 10+ точек: SSO, выделенная база, персональный менеджер. Цена договорная — <a href="mailto:sales@labus.pro">sales@labus.pro</a>.</li>
                    <li>Если раздел недоступен на текущем тарифе — вместо него откроется страница с предложением перейти на нужный уровень.</li>
                </ul>
            </div>
